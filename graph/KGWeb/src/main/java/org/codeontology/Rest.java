    ...
    private String extractNewProject(String projectID, String commitId, String gitURL, String projectPath, String extra, boolean retMessage){
        ...
        if(!new File(projectPath).exists()){
            if(!GitUtil.gitCloneAndCheckout(gitURL, projectPath, commitId)) {
                ...
                json.put("message", "git clone error");
                return json.toJSONString();
            }
        }else{
            if(!GitUtil.gitCheckout(projectPath, commitId)){
                json.put("result", "fail");
                json.put("message", "commitID not exist");
                return json.toJSONString();
            }
        }
...
//        }
    ...
    @POST
    @Path("/addCommentAndAPISeq")
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String addCommentAndAPISeq(@Context HttpServletRequest request) {
        JSONObject json = getJSONFromRequest(request);
        String projectID = json.getString("projectID");
        String commitId = json.getString("commitId");
        String projectPath = json.getString("projectPath");
        ...
        String arg = String.format("-p %s -i %s --do-not-download --commit-id %s --is-add-comment-apiseq", projectID, projectPath, commitId);
        if(!StringUtils.isEmpty(extra)){
            arg = arg + " " + extra;
        }
        arg = customizationArgs(projectName, arg);
...
//            json.put("jsonFilePath", jsonFilePath);
    ...
    @POST
    @Path("/versionInfoToFile")
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public String querySpecificVersionInfoToFile(@Context HttpServletRequest request, @Context HttpServletResponse response) {
        JSONObject json = getJSONFromRequest(request);
        String projectID = json.getString("projectID");
        String commitId = json.getString("commitId");
        String projectPath = json.getString("projectPath");
...
//            writeFileToResponse(jsonFilePath, response);
    ...
    private static String customizationArgs(String projectID, String arg){
        ...
        if(projectID.toLowerCase().equals("mockito")){
            ...
            return arg + " --ignore-dir saxon642,r2.0,incr1,circle,tests/new,tests/errors,bugs,bugs150,bugs151,bugs152,bugs153,bugs154,bugs160,bugs161,bugs162,bugs163,bugs164,bugs165,bugs166,bugs167,bugs169,bugs1610,bugs1611,bugs1612,bugs170,bugs171,bugs172,bugs173,bugs174,bugs175,bugs180,bugs181,bugs182,bugs183,bugs184,bugs185,bugs186,bugs187,bugs188,bugs189,bugs190,bugs191,bugs192,bugs193,bugs194,bugs195,bugs196,bugs1610,bugs1611,bugs1612,bugs1810,bugs1811,bugs1813,tests/pureJava,ajde/examples/spacewar,ajdoc/testdata/spacewar,ajdoc/testdata/figures-demo,classWAroundClosureRemoved,tests/incremental/model,java5,pr114875,testdata/binaryParents,multiIncremental,features151/newarrayjoinpoint,features151/ataround,weaver/testdata/forAsmDelegateTesting,features152/synchronization,features153,weaver5/java5-testsrc,tests/ltw,ajde/testdata/examples,ajde.core/testdata/figures-coverage,testing/testdata/figures-coverage,features160/annotationValueMatching,features160/parameterAnnotationMatching,features161/optimizedAnnotationBinding,incrementalPerformance/Proj64/inc1,features164/declareMixin,features167/intertype,features169/transparent,features167/overweaving,features169/itdInnerTypes,features1611/declareMinus,tests/indy,tests/bugs193/333274/ma,tests/bugs193/333274/ma2/aspect1,tests/bugs193/333274/ma2/aspect2,tests/bugs193/333274/ma2/aspect3,ajde/testdata/figures-coverage,bcel-builder/testdata/modules,tests/ant/src,org.aspectj.matcher/src/test/java/org/aspectj/weaver,tests/features193 " +
                    ...
                    "AnnotatedClass,ajdoc/src/org/aspectj/tools/ajdoc/Util,bugs150/PR83303,ajde/testdata/examples/coverage/ModelCoverage,testdata/src1/Good,ajde/testdata/examples/coverage/ModelCoverage,ajdoc-testsrc/org/aspectj/tools/ajdoc/AjdocTests,TestClass,bcel-builder/testdata/SimpleType,org.aspectj.matcher/testsrc/org/aspectj/weaver/TestShadow,model/prX/Code,features1611/metamatching/Code,model/pr115607/pr115607,testing/testsrc/org/aspectj/testing/util/UtilTests,bcel-builder/testdata/lambda/one/Code,features195/textblock/Code,features167/timers/one/Code,tests/apt/test2/Code,features195/textblock/Code2,org.aspectj.ajdt.core/testdata/src1/AroundA1,tests/features190/efficientTJP/Four";
            ...
            return arg + " --ignore-file webapps/examples/jsp/plugin/applet/Clock2,org/apache/catalina/startup/CatalinaBaseConfigurationSource";
        }else if(projectID.toLowerCase().equals("eclipse.jdt.ui")){
            return arg + " --ignore-dir org.eclipse.jdt.junit.core,org.eclipse.jdt.ui.tests.refactoring/resources,org.eclipse.jdt.ui.tests/testresources/JUnitWorkspace/JUnitTests,JUnit/org/eclipse/jdt/internal/junit,org.eclipse.jdt.junit/src/org/eclipse/jdt/internal/junit/runner,refactoring/org/eclipse/ltk " +
                    "--ignore-file Before,Modified,Test,org.eclipse.jdt.ui/ui/org/eclipse/jdt/internal/ui/text/link/LinkedPositionManager,org.eclipse.jdt.ui/preview/formatter";
//            return arg + " --ignore-dir org.eclipse.jdt.ui.tests.refactoring/resources/IntroduceParameterObject " +
//                    "--ignore-file A,B,C,P,Z,A_test.*,I,Test,A1,Inner,SomeClass,FooParameter,Bar,UseTestClass,TestClass,TestDefaultPackagePoint,MultipleCallers_in,Foo";
        }else if(projectID.toLowerCase().equals("eclipse.platform.ui")){
            return arg + " --ignore-dir org.eclipse.core.databinding/src,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/dialogs,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/model,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/actions,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/dialogs,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/part,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/wizards,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/internal/model,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/internal/actions,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/internal/dialogs,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/internal/misc,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/internal/registry,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/internal/roles" +
                    ",bundles/org.eclipse.ui.views/src/org/eclipse/ui/views/bookmarkexplorer,bundles/org.eclipse.ui.views/src/org/eclipse/ui/views/contentoutline,bundles/org.eclipse.ui.views/src/org/eclipse/ui/views/framelist,bundles/org.eclipse.ui.views/src/org/eclipse/ui/views/markers,bundles/org.eclipse.ui.views/src/org/eclipse/ui/views/navigator,bundles/org.eclipse.ui.views/src/org/eclipse/ui/views/tasklist,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/views/properties,bundles/org.eclipse.ui.ide/extensions/org/eclipse/ui,org/eclipse/ui/internal/presentations/newapi,examples/org.eclipse.jface.examples.databinding/src/org/eclipse/jface/layout,UI/org/eclipse/ui/testing,Tests/org/eclipse/ui/tests/performance,tests/org.eclipse.ui.tests.harness/src/org/eclipse/ui/tests/internal/util" +
                    ",Tests/org/eclipse/jface/tests/performance,Utils/org/eclipse/ui/tests/performance " +
                    "--ignore-file org.eclipse.ui.workbench.compatibility/src/org/eclipse/ui/internal/CompatibleWorkbenchPage,org.eclipse.ui.workbench.compatibility/src/org/eclipse/ui/internal/ICompatibleWorkbenchPage,tests/org.eclipse.e4.ui.tests.css.swt/tkuiTestsToRefactor/swt/test/org/akrogen/tkui/css/core/examples/csseditors/AbstractCSSEditor,tests/org.eclipse.ui.tests.navigator/src/org/eclipse/ui/tests/navigator/NavigatorTestSuite,tests/org.eclipse.ui.tests.performance/src/org/eclipse/ui/tests/performance/layout/PresentationWidgetFactory" +
                    ",bundles/org.eclipse.ui.ide/src/org/eclipse/ui/[^/]*,bundles/org.eclipse.ui.ide/src/org/eclipse/ui/internal/[^/]*,tests/org.eclipse.ui.tests.navigator/navigator-test-src/org/eclipse/ui/tests/navigator/NavigatorTestSuite";
        }
        return arg;
    }
