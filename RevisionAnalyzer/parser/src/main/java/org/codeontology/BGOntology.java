...
public class BGOntology {
    ...
    public static final Property COMMENT_PROPERTY = model.getProperty(BGOntology_ + "comment");
    public static final Property DOCCOMMENT_PROPERTY = model.getProperty(BGOntology_ + "doccomment");
    public static final Property APISEQ_PROPERTY = model.getProperty(BGOntology_ + "apiseq");
}
